...
function detectCurrency(line, fallback = 'PLN') {
...
function isSkippableLine(line) {
  ...
  if (SKIP_PATTERNS.some(pattern => pattern.test(line))) return true;
  return false;
}

function parseItemLine(line, fallbackCurrency) {
...
export function parseReceiptText(text, fallbackCurrency = 'PLN') {
